...
from .renderers import ArticleJSONRenderer, CommentJSONRenderer, HistoryJSONRenderer
...
class ArticleViewSet(mixins.CreateModelMixin, 
    ...
    # history
    history_queryset = History.objects.select_related('slug', 'slug')
    history_renderer_classes = (HistoryJSONRenderer,)
    ...
    def create(self, request):
        ...
        try:
            ...
            print('serializer_data in create: ', serializer_data)
            print('error: ', e)
...
class ArticleHistoryAPIView(APIView):
    ...
    def get(self, request, article_slug=None):
        ...
        try:
            history = History.objects.filter(slug=article_slug).order_by('-updated_at').values()
            serializer = self.serializer_class(history, context=serializer_context, many=True)
        except Article.DoesNotExist:
            raise NotFound('An article with this slug was not found.')
        except History.DoesNotExist:
            raise NotFound('An history with this title, created_at was not found.')
